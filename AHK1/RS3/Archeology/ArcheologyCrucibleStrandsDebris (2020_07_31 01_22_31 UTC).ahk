...
Loop{
	...
	Sleep NormalRand(15000,16000,int=1)
...
clickArcheologyPile() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(808,808,1), NormalRand(416,416,1), stringInput)
	...
	OutputVarX := 0
	OutputVarY := 0
	ImageSearch, OutputVarX, OutputVarY, X1, Y1, X2, Y2, *55 crucible.png
	If (ErrorLevel == 0){
		timingVariable := NormalRand(748,1048,1)
...
clickArcheologyPileAfterDeposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(396,396,1), NormalRand(56,56,1), stringInput)
...
Deposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(509,509,1), NormalRand(465,465,1), stringInput)
