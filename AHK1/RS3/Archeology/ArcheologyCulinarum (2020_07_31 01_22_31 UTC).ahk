...
clickArcheologyPile() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(739,749,1), NormalRand(443,453,1), stringInput)
...
clickArcheologyPileAfterDeposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(543,553,1), NormalRand(248,258,1), stringInput)
...
Deposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(1105,1115,1), NormalRand(643,653,1), stringInput)
