...
clickArcheologyPile() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(915,918,1), NormalRand(554,557,1), stringInput)
...
clickArcheologyPileAfterDeposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(98,99,1), NormalRand(386,387,1), stringInput)
...
Deposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(1749,1750,1), NormalRand(694,697,1), stringInput)
