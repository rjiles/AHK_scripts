...
openBankPriff() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(522,551,1), NormalRand(427,448,1), stringInput)
	X1 := 0
	Y1 := 0
	X2 := 1980
	Y2 := 1080
...
mouseCampfire() {
	...
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(1040,1099,1), NormalRand(590,676,1), stringInput)
	X1 := 0
	Y1 := 0
	X2 := 1980
	Y2 := 1080
...
interfaceReset() {
	...
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(1278,1302,1), NormalRand(43,59,1), stringInput)
