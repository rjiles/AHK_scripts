...
clickTree() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(730,849,1), NormalRand(314,398,1), stringInput)
	X1 := 0
	Y1 := 0
	X2 := 1980
	Y2 := 1080
	...
	stringInput := "T" . timingVariable . " P4-2" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(710,884,1), NormalRand(252,310,1), stringInput)
}
