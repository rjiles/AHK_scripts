...
clickArcheologyPile() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(824,824), NormalRand(430,431,1), stringInput)
...
clickArcheologyPileAfterDeposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(975,975,1), NormalRand(348,348,1), stringInput)
...
Deposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(471,471,1), NormalRand(615,615,1), stringInput)
