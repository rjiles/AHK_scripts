...
clickArcheologyPile() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(784,794,1), NormalRand(434,444,1), stringInput)
	...
	OutputVarX := 0
	OutputVarY := 0
	ImageSearch, OutputVarX, OutputVarY, X1, Y1, X2, Y2, *55 big.png
	If (ErrorLevel == 0){
		timingVariable := NormalRand(748,1048,1)
...
clickArcheologyPileAfterDeposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(672,685,1), NormalRand(351,365,1), stringInput)
...
Deposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(1067,1077,1), NormalRand(668,678,1), stringInput)
