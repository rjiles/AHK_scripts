...
clickArcheologyPile() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(960,962,1), NormalRand(524,525,1), stringInput)
...
clickArcheologyPileAfterDeposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(1190,1191,1), NormalRand(485,487,1), stringInput)
...
Deposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(653,654,1), NormalRand(559,560,1), stringInput)
