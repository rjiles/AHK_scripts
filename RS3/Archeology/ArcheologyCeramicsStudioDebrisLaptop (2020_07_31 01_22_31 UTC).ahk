...
clickArcheologyPile() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(806,807,1), NormalRand(435,436,1), stringInput)
...
clickArcheologyPileAfterDeposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(1031,1032,1), NormalRand(389,390,1), stringInput)
...
Deposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(474,475,1), NormalRand(465,466,1), stringInput)
