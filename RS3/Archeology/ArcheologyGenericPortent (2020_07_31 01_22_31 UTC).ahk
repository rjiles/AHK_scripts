...
Del::
 ...
 checkPortent() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(1470,1471,1), NormalRand(456,457,1), stringInput)
	...
	OutputVarX := 0
	OutputVarY := 0
	ImageSearch, OutputVarX, OutputVarY, X1, Y1, X2, Y2, *55 portentWorn.png
	If (ErrorLevel == 0){
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(1427,1428,1), NormalRand(456,457,1), stringInput)
	...
	if (missing == 1) {
		...
		OutputVarX := 0
		OutputVarY := 0
		ImageSearch, OutputVarX, OutputVarY, X1, Y1, X2, Y2, *55 portentInv.png
		If (ErrorLevel == 0){
			timingVariable := NormalRand(748,1048,1)
...
clickArcheologyPile() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(789,830,1), NormalRand(418,430,1), stringInput)
	...
	OutputVarX := 0
	OutputVarY := 0
	ImageSearch, OutputVarX, OutputVarY, X1, Y1, X2, Y2, *55 ice.png
	If (ErrorLevel == 0){
		timingVariable := NormalRand(748,1048,1)
		stringInput := "T" . timingVariable . " P1-1" 
		MouseGetPos, MouseX, MouseY
...
clickArcheologyPileAfterDeposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(570,570,1), NormalRand(763,763,1), stringInput)
	...
	OutputVarX := 0
	OutputVarY := 0
	ImageSearch, OutputVarX, OutputVarY, X1, Y1, X2, Y2, *55 goblin.png
	If (ErrorLevel == 0){
		timingVariable := NormalRand(748,1048,1)
		stringInput := "T" . timingVariable . " P1-1" 
		MouseGetPos, MouseX, MouseY
...
Deposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(1067,1067,1), NormalRand(159,159,1), stringInput)
...
interfaceReset() {
	...
	Sleep NormalRand(3000,4000,int=1)
	Send {Up up}
	Sleep NormalRand(45,58,int=1)
