...
Loop{
	...
	Sleep NormalRand(20000,21000,int=1)
...
clickArcheologyPile() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(732,750,1), NormalRand(449,469,1), stringInput)
	...
	OutputVarX := 0
	OutputVarY := 0
	ImageSearch, OutputVarX, OutputVarY, X1, Y1, X2, Y2, *55 gravitron.png
	If (ErrorLevel == 0){
		timingVariable := NormalRand(748,1048,1)
...
clickArcheologyPileAfterDeposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(312,322,1), NormalRand(490,500,1), stringInput)
...
Deposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(1208,1218,1), NormalRand(400,410,1), stringInput)
