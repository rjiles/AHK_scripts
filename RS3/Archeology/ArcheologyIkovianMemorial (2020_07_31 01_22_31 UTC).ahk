...
Loop{
	...
	Sleep NormalRand(15000,20000,int=1)
	...
	Sleep NormalRand(5000,6000,int=1)
	
	Send {3 down}  ; Press down the up-arrow key.
...
Deposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(727,728,1), NormalRand(364,365,1), stringInput)
