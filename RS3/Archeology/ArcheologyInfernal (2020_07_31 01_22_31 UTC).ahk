...
clickArcheologyPile() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(961,963,1), NormalRand(597,600,1), stringInput)
...
clickArcheologyPileAfterDeposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(948,950,1), NormalRand(787,790,1), stringInput)
...
Deposit() {
	...
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	RandomBezier(MouseX, MouseY, NormalRand(986,990,1), NormalRand(392,400,1), stringInput)
