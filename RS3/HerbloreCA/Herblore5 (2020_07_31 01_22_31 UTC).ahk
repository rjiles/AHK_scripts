...
Loop{
	...
	Sleep NormalRand(23,110,int=1)
	Send {Space up}
	Sleep NormalRand(6000,6250,int=1)
}
...
openBankPriff() {
	...
	RandomBezier(MouseX, MouseY, NormalRand(1300,1301,1), NormalRand(532,535,1), stringInput)
...
mouseCampfire1() { ;north
	Sleep NormalRand(581,984,int=1)
	timingVariable := NormalRand(748,1048,1)
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
	;RandomBezier(MouseX, MouseY, NormalRand(950,952,1), NormalRand(250,251,1), stringInput)
	RandomBezier(MouseX, MouseY, NormalRand(920,921,1), NormalRand(210,211,1), stringInput)
...
mouseCampfire3() { ;on top of player standing at bank
	Sleep NormalRand(581,984,int=1)
	timingVariable := NormalRand(748,1048,1)
	stringInput := "T" . timingVariable . " P5-4" 
	MouseGetPos, MouseX, MouseY
